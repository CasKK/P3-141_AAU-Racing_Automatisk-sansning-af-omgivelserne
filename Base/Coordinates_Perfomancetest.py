...
coordinates_listB = [[567,278, 0],
                    [71,269, 0],
                    [435,217, 0]]
coordinates_listY = [[204,216, 1],
                     [393,203, 1],
                    [241,219, 1]]

depth_listB = [1020, 2330, 3540]     # Some 'random' distances for testing purposes as no real test data is available currently.
depth_listY = [1030, 2330, 3540]
...
def main():
    ...
    print(f"M113 oldPointsY: {oldPointsY}")
main()
######### run ###########
